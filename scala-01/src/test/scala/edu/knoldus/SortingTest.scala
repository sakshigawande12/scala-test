...
class SortingTest extends WordSpec {
  ...
  var sortedList: List[Int] = List(1, 2, 3, 4, 5)
  var unSortedList: List[Int] = List(2, 3, 1, 5, 4)
  var reversedList: List[Int] = List(5, 4, 3, 2, 1)
  var listWithNegativeIntegers: List[Int] = List(1, -1, 2, -2)
